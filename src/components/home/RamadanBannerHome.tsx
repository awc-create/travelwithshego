...
export default function RamadanHomeBanner({ paypalUrl }: RamadanHomeBannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Ramadan 2025 appeal">
      <div className={styles.inner}>
        <div className={styles.textBlock}>
          <p className={styles.pill}>Ramadan 2025 • Special Appeal</p>
          <h2 className={styles.title}>Share Iftar & Hope this Ramadan.</h2>
          <p className={styles.body}>
            This Ramadan we&apos;re raising a dedicated fund for food packs, iftar meals and
            essentials for families in Baraawe. Every dollar helps a family sit down to a meal they
